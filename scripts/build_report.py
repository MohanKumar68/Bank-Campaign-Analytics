"""
Academic Report Builder for MohanKumarM_BankCampaignAnalytics_Report.docx
Generates a comprehensive, professionally styled Word document adhering to
all 23 specified chapters, embedding real empirical metrics and high-res figures.
"""
...
def create_report():
    ...
    # =========================================================================
    add_heading_1("4. Problem Statement")
    add_body(
    ...
    # =========================================================================
    # CHAPTER 6: BUSINESS CONTEXT
    # =========================================================================
    add_heading_1("6. Business Context")
    add_body(
    ...
    # =========================================================================
    add_heading_1("7. Dataset Description")
    add_body(
    ...
    data_dict = [
        ...
        ("balance", "Numeric (Integer)", "Average yearly balance in euros (€)."),
    ...
    # =========================================================================
    add_heading_1("10. Data Preprocessing")
    add_body(
    ...
    # =========================================================================
    add_heading_1("11. Exploratory Data Analysis")
    add_body(
    ...
    add_heading_2("11.1 Target Distribution and Class Imbalance")
    add_image_box("outputs/figures/eda_target_distribution.png", "Figure 1: Target Variable Distribution (y)")
    add_body(
        "As illustrated in Figure 1, the target variable exhibits significant class imbalance. Out of 4,521 contacts, 4,000 clients (88.48%) declined "
    ...
    add_heading_2("11.2 Subscription Rate by Occupation")
    add_image_box("outputs/figures/eda_job_subscription.png", "Figure 2: Subscription Rate Across Job Categories")
    add_body(
        "Figure 2 highlights significant variation across occupations. The highest conversion rates were observed among students (22.6%) and retirees "
    ...
    add_heading_2("11.3 Subscription Rate by Education Level")
    add_image_box("outputs/figures/eda_education_subscription.png", "Figure 3: Subscription Rate by Educational Attainment")
    add_body(
        "Figure 3 demonstrates that clients with tertiary education achieved an observed conversion rate of 14.3%, compared to 10.7% for secondary education "
    ...
    add_heading_2("11.4 Impact of Credit Liabilities")
    add_image_box("outputs/figures/eda_housing_loan.png", "Figure 4: Subscription Rate by Housing and Personal Loan Commitments")
    add_body(
        "Figure 4 reveals that outstanding liabilities strongly inhibit term deposit subscription. Clients without a housing loan converted at 15.3%, "
    ...
    add_heading_2("11.5 Account Balance Distribution")
    add_image_box("outputs/figures/eda_balance_distribution.png", "Figure 5: Account Balance Distribution by Subscription Status")
    add_body(
        "Figure 5 depicts the yearly average account balance across subscription outcomes. Subscribed clients displayed higher median balances "
        "(€733 vs €417) and larger upper-quartile reserves. Customers maintaining negative or negligible bank balances possess minimal discretionary savings."
    )

    add_heading_2("11.6 Campaign Contact Frequency and Outreach Diminishing Returns")
    add_image_box("outputs/figures/eda_campaign_contacts.png", "Figure 6: Subscription Rate by Number of Campaign Contacts")
    add_body(
        "Figure 6 illustrates sharp diminishing returns associated with repeated calling. Conversion is highest during the 1st contact (12.3%) and "
    ...
    add_heading_2("11.7 Previous Campaign Outcome")
    add_image_box("outputs/figures/eda_poutcome_subscription.png", "Figure 7: Subscription Rate by Previous Campaign Outcome")
    add_body(
        "Figure 7 demonstrates that customers whose previous campaign outcome was recorded as 'success' achieved an extraordinary current subscription "
    ...
    add_heading_2("11.8 Duration Analysis and Post-Contact Characteristic")
    add_image_box("outputs/figures/eda_duration_analysis.png", "Figure 8: Call Duration Distribution (Post-Contact Exploration)")
    add_body(
        "Figure 8 shows that subscribed calls averaged 9.2 minutes (555 seconds) versus 3.7 minutes (221 seconds) for non-subscribers. While this "
    ...
    # =========================================================================
    # CHAPTER 12: BUSINESS KPI ANALYSIS
    # =========================================================================
    add_heading_1("12. Business KPI Analysis")
    add_body(
    ...
    # =========================================================================
    add_heading_1("13. Feature Engineering")
    add_body(
    ...
    add_bullet("2. balance_group:", "Categorized into Negative (<€0), Low (€0-500), Medium (€501-2000), and High (>€2000) to separate debt-stressed clients from affluent savers without assuming linear returns on balance.")
    ...
    # =========================================================================
    # CHAPTER 14: MACHINE LEARNING METHODOLOGY
    # =========================================================================
    add_heading_1("14. Machine Learning Methodology")
    add_body(
    ...
    # =========================================================================
    # CHAPTER 15: DATA LEAKAGE CONSIDERATION
    # =========================================================================
    add_heading_1("15. Data Leakage Consideration")
    add_body(
    ...
    add_image_box("outputs/figures/leakage_comparison.png", "Figure 9: ROC Performance Demonstration — With vs Without Duration Leakage")
    ...
    add_body(
        "As documented in Table 3 and Figure 9, including duration inflates the ROC-AUC to 0.8959. However, this model is operationally invalid "
    ...
    # =========================================================================
    add_heading_1("16. Model Evaluation")
    add_body(
    ...
    add_image_box("outputs/figures/model_cm_logistic_regression.png", "Figure 10: Confusion Matrix — Logistic Regression (Pre-Contact)")
    add_image_box("outputs/figures/model_cm_random_forest.png", "Figure 11: Confusion Matrix — Random Forest (Pre-Contact)")
    add_image_box("outputs/figures/model_roc_curves.png", "Figure 12: Receiver Operating Characteristic (ROC) Comparison (No Duration)")
    ...
    # =========================================================================
    add_heading_1("17. Results and Discussion")
    add_body(
    ...
    add_heading_2("17.1 Feature Importance and Model Interpretation")
    add_image_box("outputs/figures/model_rf_feature_importance.png", "Figure 13: Top 15 Feature Importances — Random Forest")
    add_image_box("outputs/figures/model_lr_coefficients.png", "Figure 14: Most Influential Coefficients — Logistic Regression")
    add_body(
        "Figure 13 and Figure 14 highlight the driving variables. In the Random Forest model, continuous financial features (balance, age, day, campaign) "
    ...
    # =========================================================================
    # CHAPTER 18: BUSINESS INSIGHTS
    # =========================================================================
    add_heading_1("18. Business Insights")
    ...
    # =========================================================================
    # CHAPTER 19: BUSINESS RECOMMENDATIONS
    # =========================================================================
    add_heading_1("19. Business Recommendations")
